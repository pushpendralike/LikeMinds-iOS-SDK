...
typedef SWIFT_ENUM(NSInteger, ChatRoomInputSource, open) {
  ...
  ChatRoomInputSourceSearch = 1,
  ChatRoomInputSourceNotification = 2,
  ChatRoomInputSourceCommunityFeed = 3,
  ChatRoomInputSourceDeepLink = 4,
  ChatRoomInputSourceInternalLink = 5,
  ChatRoomInputSourceIntroductionRooms = 6,
  ChatRoomInputSourceActiveThreads = 7,
  ChatRoomInputSourceRoute = 8,
  ChatRoomInputSourceChatRoom = 9,
  ChatRoomInputSourceDirectMessageScreen = 10,
  ChatRoomInputSourceSingleEvent = 11,
  ChatRoomInputSourceUnknown = 12,
};
