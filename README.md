...
```sh
        ...
        @objc(LikeMindsView)
        class LikeMindsView: UIView {
          var activityView: UIActivityIndicatorView = UIActivityIndicatorView(style: .whiteLarge)
          ...
          @objc func addActivityIndicator() {
           ...
           @objc func addLikeMindsView(userName: NSString, userId: NSString, isGuest: Bool ) {
